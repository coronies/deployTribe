...
const StudentDashboard = () => {
  ...
  return (
    <div className="student-dashboard" style={{ zoom: zoomLevel }}>
      {/* Zoom Controls */}
      ...
      <div className="dashboard-grid">
        {/* Column 1: Recommendations (top) + Recent Activity (bottom) */}
      ...
      {/* Dashboard End Line */}
      <div className="dashboard-end-line"></div>
    </div>
  );
};
